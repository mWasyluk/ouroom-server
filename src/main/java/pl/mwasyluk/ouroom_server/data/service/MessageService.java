...
public class MessageService {
    ...
    public ServiceResponse<?> deleteMessage(@NonNull UUID requestingProfileUuid, @NonNull UUID messageUuid) {
        ...
        ServiceResponse<?> conversationServiceResponse = conversationService.getById(requestingProfileUuid,
    ...
    // TODO: Test pageable
    public ServiceResponse<?> getAllMessagesByConversationId(@NonNull UUID requestingProfileId,
            @NonNull UUID conversationId, @NonNull Pageable pageable) {
        ServiceResponse<?> conversationServiceResponse = conversationService.getById(requestingProfileId,
                conversationId);
        if (!(conversationServiceResponse.getBody() instanceof Conversation)) {
            return conversationServiceResponse;
        }
    ...
    public ServiceResponse<?> getAllMessagesByConversationId(@NonNull UUID requestingProfileId,
            @NonNull String conversationStringUuid, @NonNull Pageable pageable) {
    ...
    // public ServiceResponse<?> getLatestMessageWithLatestContacts(@NonNull UUID
    // forProfileId, int howManyProfiles, int profileOffset){
