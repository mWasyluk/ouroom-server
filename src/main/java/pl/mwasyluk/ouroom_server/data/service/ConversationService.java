...
public class ConversationService {
    ...
    public ServiceResponse<?> createConversation(@NonNull UUID requestingProfileUuid,
            @NonNull Collection<Profile> participators) {
    ...
    private Conversation getConversationWithExactParticipators(@NonNull Collection<Conversation> conversations,
        ...
        List<Conversation> matchingConversations = conversationsWithoutDuplicates.stream()
                ...
                .filter(conversation -> conversation.getParticipators().size() == participatorIdsWithoutDuplicates
                        .size())
                .collect(Collectors.toList());
    ...
    public ServiceResponse<?> addMessageToConversationById(@NonNull UUID requestingProfileUuid,
        ...
        return addMessageToConversationById(requestingProfileUuid, UUID.fromString(conversationStringUuid),
                messageToPersist);
    }
    ...
    public ServiceResponse<?> deleteConversationById(@NonNull UUID requestingProfileUuid,
            @NonNull String conversationUuidString) {
